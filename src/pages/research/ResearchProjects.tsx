    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        ...
        Research Projects
          ...
          >
Madha Dental College & Hospital actively promotes research by encouraging faculty members to undertake innovative research projects across various dental specialties.
          </p>
