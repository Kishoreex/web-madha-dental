...
<section className="pt-28 pb-10 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div
            className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden hover:shadow-3xl transition-all duration-500"
            data-aos="fade-up"
          >
              ...
              <span className="mb-3 font-['Montserrat'] text-[17px] font-semibold uppercase tracking-[0.28em] text-blue-700">     Founder & Chairman
                ...
                <div className="space-y-3 text-[17px] leading-8 text-slate-600 text-justify">
                  ...
                  <p>
                    ...
                    with knowledge, ethics and leadership qualities.
                  </p>
...
<div
  className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden hover:shadow-3xl transition-all duration-500 mt-12"
  data-aos="fade-up"
>
  ...
  <div className="grid lg:grid-cols-3">
    ...
    <div className="overflow-hidden">
      ...
      <img
        src={IMAGES.viceChairperson}
        alt="Ms. Mercy Florence Peter"
        className="w-full h-full object-cover"
      />
    ...
    <div className="lg:col-span-2 p-10 lg:p-14">
      ...
      <div className="space-y-3 text-[17px] leading-8 text-slate-600 text-justify">
        ...
        <p>
          ...
          and strategic vision to further strengthen Madha Group's
